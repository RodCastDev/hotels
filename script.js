...
const getApi = async () => {
  ...
  data.forEach((element) => {
    ...
    buttonMore.className = "HotelCard__More";
    buttonMore.id = "HotelCard__More";
    buttonMore.textContent = "+";
    const buttonCard = document.createElement("button");
    buttonCard.className = "HotelCard__Book";
    buttonCard.textContent = "Book it!";
    const cardInformation = document.createElement("section");
    cardInformation.className = "HotelCard__Info";
    const cardInfoNumbers = document.createElement("div");
    cardInfoNumbers.className = "HotelCard__Country-Numbers";
    const divCountry = document.createElement("div");
    divCountry.className = "HotelCard__Country";
    const imgCountry = document.createElement("img");
    imgCountry.className = "HotelCard__Flag";
    const country = document.createElement("p");
    country.className = "HotelCard__CountryName";
    country.textContent = element.country;
    const HotelCard__Numbers = document.createElement("div");
    HotelCard__Numbers.className = "HotelCard__Numbers";
    const HotelCard__Rooms = document.createElement("p");
    HotelCard__Rooms.className = "HotelCard__Rooms";
    HotelCard__Rooms.textContent = element.rooms + " rooms -";
    const HotelCard__Price = document.createElement("p");
    HotelCard__Price.className = "HotelCard__Price";
    HotelCard__Price.textContent = valorHotelSing(element.price);
    function valorHotelSing(numero) {
    ...
    cardHotel.appendChild(cardInfoNumbers);
    cardHotel.appendChild(cardInformation);
    cardHotel.appendChild(buttonMore);
    cardHotel.appendChild(buttonCard);
    cardInformation.appendChild(divCountry);
    divCountry.appendChild(imgCountry);
    divCountry.appendChild(country);
    cardInfoNumbers.appendChild(HotelCard__Numbers);
    cardInfoNumbers.appendChild(divCountry);
    sectionCards.appendChild(cardHotel);
    HotelCard__Numbers.appendChild(HotelCard__Rooms);
    HotelCard__Numbers.appendChild(HotelCard__Price);
  });
};
...
info__Text.textContent =
  "Hover over the cards to discover amazing information! ";
